...
const MyInterviews = () => {
  ...
  const tabs = [
    { name: 'Saved', path: '/saved', count: 1, active: false },
    { name: 'Applied', path: '/applied', count: 1, active: false },
    { name: 'Interviews', path: '/interviews', count: 2, active: true }, // Explicitly Active
    { name: 'Archived', path: '/archived', count: 1, active: false },
  ];

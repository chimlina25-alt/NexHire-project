...
import {
  Shield, AlertTriangle, Mail, Save, User, Trash2, LogOut,
  ChevronRight, Lock, Eye, EyeOff, Briefcase, ExternalLink,
  UserCog, FileText, Loader2, CheckCircle2, XCircle,
} from "lucide-react";
...
const EmployeeSettings = () => {
  ...
  // ++ ADDED — OTP verification step state
  ...
  // ++ MODIFIED — step 1: send OTP to new email
  ...
  // ++ ADDED — step 2: verify OTP and apply email change
  const handleVerifyEmailOtp = async () => {
    ...
    try {
      ...
      // Success — update displayed email and reset state
          ...
          <aside className="flex-shrink-0 lg:w-72">
                  ...
                  <button
                    ...
                    className={`w-full px-5 py-4 text-sm font-bold transition-all ${
                      ...
                      isActive
                        ...
                        : isDanger ? "text-red-400 hover:bg-red-50 hover:text-red-600" : "text-[#4a5a55] hover:bg-[#f8faf9] hover:text-[#071a15]"
                    }`}
                  >
            ...
            >
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#f0f4f3]">
                {logoutLoading ? <Loader2 size={16} className="animate-spin text-[#6b7f79]" /> : <LogOut size={16} className="text-[#6b7f79]" />}
              </div>
          ...
          <div className="min-w-0 flex-1">
            ...
            {activeTab === "general" && (
              <div className="space-y-6">
                  ...
                  <div className="p-8">
                    {profileLoading ? (
                      ...
                      <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <SummaryCard icon={FileText} label="CV" value={profile.cvFileName || (profile.cvUrl ? "Resume available" : "No CV uploaded")} />
                      </div>
                    )}
                    <div className="mt-6 rounded-2xl border border-[#d1e8e3] bg-[#f0f9f6] p-5">
                      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                          <p className="text-sm font-extrabold text-[#071a15]">Edit your profile from the profile page</p>
                          <p className="mt-1 text-sm font-medium text-[#4a5a55]">Keep your public information, profile image, and CV in one place.</p>
                        </div>
                        <Link href="/profile">
                ...
                {/* ++ MODIFIED — Account Email with 2-step OTP verification */}
                <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                  <div className="border-b border-gray-100 px-8 py-6">
                  ...
                  <div className="max-w-md space-y-6">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        />
                        <button type="button" onClick={() => setShowCurrent(!showCurrent)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#6b7f79] hover:text-[#071a15]">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`${inputClass} pl-10 pr-10`}
                        />
                        <button type="button" onClick={() => setShowNew(!showNew)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#6b7f79] hover:text-[#071a15]">
                          {showNew ? <EyeOff size={16} /> : <Eye size={16} />}
                        </button>
                      </div>
                      <p className="ml-1 mt-2 text-xs font-semibold text-[#6b7f79]">Must be at least 8 characters.</p>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`${inputClass} pl-10 pr-10 ${passwordForm.confirmPassword && passwordForm.confirmPassword !== passwordForm.newPassword ? "border-red-300 focus:border-red-400 focus:ring-red-200" : ""}`}
                        />
                        <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#6b7f79] hover:text-[#071a15]">
                  ...
                  <div className="rounded-2xl border border-red-100 bg-red-50/30 p-7">
                    <div className="mb-6 flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm font-medium leading-relaxed text-[#4a5a55]">
                          This will permanently delete your account{fullName !== "—" ? ` for ${fullName}` : ""}, saved jobs, messages, and profile history. This action cannot be reversed.
                        </p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-extrabold transition-all ${deleteText === "DELETE" && !deleteLoading ? "bg-red-600 text-white hover:bg-red-700" : "cursor-not-allowed bg-red-100 text-red-300"}`}
                      >

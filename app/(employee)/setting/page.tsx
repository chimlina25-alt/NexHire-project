                ...
                <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                  ...
                  <div className="p-8">
                    <div className="grid gap-4 md:grid-cols-2">
                      <SummaryCard icon={User} label="Full Name" value="Marsslu SMC" />
                      <SummaryCard icon={MapPin} label="Location" value="Phnom Penh, Cambodia" />
                      <SummaryCard icon={Briefcase} label="Education" value="Bachelor" />
                      <SummaryCard icon={FileText} label="CV" value="Resume available" />
                    </div>
                      ...
                      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                          ...
                          <p className="mt-1 text-sm font-medium text-[#4a5a55]">
                            Keep your public information, profile image, and CV in one place instead of duplicating forms here.
                          </p>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setSettings((prev) => ({ ...prev, accountEmail: e.target.value }))
                            }
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setSettings((prev) => ({ ...prev, recoveryEmail: e.target.value }))
                            }
                            className={`${inputClass} pl-10`}
                          />
                        </div>
                ...
                <div className="p-8">
                  <div className="rounded-2xl border border-red-100 bg-red-50/30 p-7">
                    <div className="mb-6 flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-base font-extrabold text-[#071a15]">Delete Job Seeker Account</h3>
                        <p className="mt-1 text-sm font-medium leading-relaxed text-[#4a5a55]">
                          This will permanently delete your account, saved jobs, messages, and profile history. This action cannot be reversed.
                        </p>
                      </div>
                    </div>

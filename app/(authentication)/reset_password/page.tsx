          ...
          <div className="flex items-center overflow-y-auto px-6 py-8 md:w-1/2 md:px-10 md:py-8">
            <div className="mx-auto w-full max-w-sm">
              <div className="mb-4 flex justify-center">
                <img src="/res.png" alt="Reset Password Illustration" className="h-auto w-[150px] object-contain sm:w-[170px] md:w-[190px]" />
              </div>

              <div className="mb-6 text-center">
                <h1 className="mb-2 text-[28px] font-bold leading-tight text-[#00a37b] md:text-[30px]">Create a new password</h1>
...
<<<<<<< HEAD
              <form className="space-y-4" onSubmit={onSubmit}>
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-200 bg-[#f8fafc] px-4 py-3 pr-11 text-sm text-gray-900 placeholder:text-gray-400 transition-all caret-[#00a37b] focus:border-[#00a37b] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#00a37b]/15"
                      required
                    />
                    <button
                      type="button"
                ...
                <div className="space-y-1.5">
                  <label className="ml-1 block text-sm font-semibold text-[#00a37b]">Confirm new password</label>
                  <div className="relative">
                    <input

          ...
          <div className="flex items-center overflow-y-auto px-6 py-8 md:w-1/2 md:px-10 md:py-8">
            <div className="mx-auto w-full max-w-sm">
              <div className="mb-6 text-center">
                <h1 className="mb-2 text-[28px] font-bold leading-tight text-[#00a37b] md:text-[30px]">Get Started Now!</h1>
                <p className="text-sm leading-6 text-gray-500">Get started with your free account today</p>
              </div>

              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <FormInput label="Email" type="email" placeholder="Enter your email" registration={register("email")} error={errors.email} />
                <FormInput label="Password" placeholder="Enter your password" toggleable registration={register("password")} error={errors.password} />
                <FormInput label="Confirm Password" placeholder="Confirm your password" toggleable registration={register("confirmPassword")} error={errors.confirmPassword} />
              ...
              <div className="mt-6">
                <div className="relative mb-4 flex items-center justify-center">
                  ...
                  <span className="absolute bg-white px-4 text-[10px] uppercase tracking-widest text-gray-400">Or continue with</span>
                </div>

               <button
  type="button"
  onClick={() => signIn("google", { callbackUrl: "/google-callback?mode=signup" })}

      ...
      <div className="bg-white rounded-[45px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] flex flex-col md:flex-row max-w-6xl w-full overflow-hidden relative z-10">
        ...
        <div className="md:w-1/2 p-6 md:p-8">
          <div className="h-full w-full rounded-[35px] overflow-hidden relative">
            ...
            {/* BACK BUTTON: Matches the design in nh13.jpg */}
        ...
        <div className="md:w-1/2 flex flex-col justify-center px-10 md:px-20 py-16">
          ...
          <div className="text-center mb-10">
            <h1 className="text-[#00a37b] text-4xl font-bold mb-4">Create a new password</h1>
          ...
          <form className="space-y-8">
            ...
            <div className="space-y-2">
              <label className="text-[#00a37b] font-bold text-sm block ml-1">New password</label>
              <input 
                type="password" 
                placeholder="Enter your new password" 
                className="w-full px-5 py-4 rounded-2xl border border-gray-200 bg-[#f8fafc] focus:outline-none focus:ring-2 focus:ring-[#00a37b] focus:bg-white transition-all placeholder:text-gray-300"
                required
              />
            </div>

            <div className="space-y-2">
              <label className="text-[#00a37b] font-bold text-sm block ml-1">Confirm new password</label>
              <input 
                type="password" 

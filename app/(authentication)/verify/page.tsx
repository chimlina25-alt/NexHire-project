        ...
        <div className="flex h-[calc(100vh-2rem)] w-full flex-col overflow-hidden rounded-[34px] bg-white shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] md:h-[calc(100vh-4rem)] md:flex-row">
          <div className="p-4 md:w-1/2 md:p-5">
            <div className="relative h-full w-full overflow-hidden rounded-[28px]">
              <img src="/au.jpg" alt="NexHire Workspace" className="h-full w-full object-cover" />
              <div className="absolute top-7 left-7 flex items-center gap-3">
                ...
                <span className="text-[21px] font-semibold tracking-tight text-white drop-shadow-md">NexHire</span>
              </div>
              <div className="absolute bottom-7 left-7">
                <Link href={backHref} className="inline-flex items-center gap-2 rounded-full border border-white/40 bg-black/20 px-4 py-2 text-sm font-medium text-white backdrop-blur-md transition-all hover:bg-white hover:text-black">
                  <ArrowLeft size={15} />
                  Back
                </Link>
              </div>
            ...
            <div className="mx-auto w-full max-w-sm text-center">
              <div className="mb-5 flex justify-center">
                <div className="rounded-xl bg-[#f0fdf9] p-3">
                  <Mail className="h-9 w-9 text-[#00a37b]" strokeWidth={1.7} />
                </div>
              </div>
              <div className="mb-6">
                <h1 className="mb-2 text-[22px] font-semibold leading-snug text-[#00a37b] md:text-[25px]">Verify your identity</h1>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <button type="submit" disabled={submitting} className="w-full rounded-lg bg-[#00a37b] py-3 text-sm font-semibold text-white shadow-md shadow-[#00a37b]/20 transition-all hover:bg-[#008f6c] active:scale-[0.99] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#00a37b]/15 disabled:cursor-not-allowed disabled:opacity-60">
                  {submitting ? "Verifying..." : "Verify"}
                </button>
              </form>
              <p className="mt-5 text-sm text-gray-500">
                Don&apos;t receive the code?{" "}
                <button type="button" onClick={handleResend} className="font-semibold text-[#00a37b] hover:underline">Resend</button>
              </p>
              {resendMessage && <p className="mt-3 text-sm text-[#00a37b]">{resendMessage}</p>}
            </div>
          </div>
        </div>
      </div>
